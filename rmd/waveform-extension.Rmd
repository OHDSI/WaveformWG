...
This guide serves as an addendum to the previously published [Multimodal Linkage SOP](https://chorus-ai.github.io/Chorus_SOP/docs/Multimodal-Linkage/), which first introduced the waveform_registry table. This expanded specification reflects a broader, semantically integrated model for representing waveform acquisition events, derived features, and signal metadata.
...
See [Office Hours](office-hours.html) for recorded implementation discussions and Q&A sessions.
